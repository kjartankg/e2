function [data] = stepper_var_step_var_c(f, x_0, t_0, t_n, tol, theta, eta)
%------------------------------------------------------------------------------
...
% size using an error constant that is varies with respect to the step size
% ratio.
%------------------------------------------------------------------------------
    ...
    while isNotDone
        ...
        c     = err.error_constant(r, theta);
        c_err = err.error_constant(r, eta);
